...
const enTranslations = {
  ...
  about: {
    title: "About Me",
    description: "Senior Frontend Engineer with 5+ years of experience in building performant, accessible, and beautiful web applications.",
    background: "As a passionate frontend engineer, I specialize in creating intuitive and responsive user interfaces with React, TypeScript, and Next.js. I have a strong background in developing enterprise-grade applications, implementing design systems, and optimizing web performance. I'm constantly learning new technologies to deliver exceptional digital experiences.",
    skills: "Skills",
